...
const ThemeToggle = ({theme}) => {
  return (
    ...
    >
      <AnimatePresence>
        {theme === "light" ? (
          <motion.div key="light-icon" initial={{rotate: -90}} animate={{rotate: 0}} transition={{duration: 0.5}}>
          ...
          <motion.div key="dark-icon" initial={{rotate: 90}} animate={{rotate: 0}} transition={{duration: 0.5}}>
