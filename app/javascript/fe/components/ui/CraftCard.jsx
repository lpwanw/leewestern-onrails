  ...
  return (
    <div className={cn(
      ...
      <div className={cn(
        ...
        <ReactPlayer playing={true} loop playsinline url={videoUrl} width="100%" height={"auto"}/>
      ...
      {url && (
        <Link to={url} className="mt-1 dark:text-gray-200 rounded-xl bg-neutral-800 transition-all hover:bg-neutral-700 w-full py-2 flex justify-center items-center">
